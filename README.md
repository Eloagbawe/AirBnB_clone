...
This is a team project to build a clone console of AirBnB.

The console is a command interpreter to manage objects abstraction between objects and how they are stored. The console will perform the following fundamental tasks:
...
- GitHub
          ...
          Style guidelines
The following style guidelines were adopted:

- pycodestyle (version 2.7.*)
- PEP8

All the development and testing was run over by the ubuntu operating system 20.04 LTS using the Python 3.8.3 programming language. The editors used were Vim 8.1.2269 and VSCode 1.6.1 while the control version using Git 2.25.1.
